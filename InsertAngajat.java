...
public class InsertAngajat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Marca Angajat");

        jLabel2.setText("Nume Angajat");

        jLabel3.setText("Salariu Angajat");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            PrintWriter pw = new PrintWriter(new FileOutputStream("angajati.txt",true));
            System.out.println("fisier creat cu succes");
    ...
    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtonActionPerformed
        // TODO add your handling code here:
        AngajatiManagement lb = new AngajatiManagement();
        lb.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertAngajat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
