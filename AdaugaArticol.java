 ...
 * @author soare
 */
public class AdaugaArticol extends javax.swing.JFrame {
    
    /**
     * Creates new form InsertItem
     */
    public AdaugaArticol() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pret U/M");

        jLabel3.setText("Cantitate Gestiune");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            PrintWriter pw = new PrintWriter(new FileOutputStream("articole.txt",true));
        ...
        name.setText("Produs");
        price.setText("Lei");
        quantity.setText("Buc");
        JOptionPane.showMessageDialog(this, "Produsul a fost adăugat");
