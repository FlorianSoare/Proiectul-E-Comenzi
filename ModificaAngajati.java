 ...
 * @author soare
 */
public class ModificaAngajati extends javax.swing.JFrame {
    private MdfLabour m;
    ...
    private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
        ...
        mPrice.setText("");
        mQuantity.setText("");
         JOptionPane.showMessageDialog(this, "Datele Angajatului au fost modificate");
    }//GEN-LAST:event_modifyButtonActionPerformed

    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtonActionPerformed
        // TODO add your handling code here:
       AngajatiManagement lm = new AngajatiManagement();
        lm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        */
        try {
            ...
            java.util.logging.Logger.getLogger(ModificaAngajati.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificaAngajati().setVisible(true);
            }
        });
    }
...
class MdfLabour {
    ...
    private void openFile()
    {
        try
        {
            scan = new Scanner(new File("angajati.txt"));
    ...
    public  void ModifyItem(){
        ...
        try{
            Scanner sc = new Scanner(new FileInputStream("angajati.txt"));
            ...
            sc.close();
            sc = new Scanner(new FileInputStream("angajati.txt"));
            while(sc.hasNextLine()){
        ...
        try {
            PrintWriter pw = new PrintWriter(new FileOutputStream("angajati.txt"));
            for (int i = 0; i < c; i++) {
            ...
            System.out.println("Datele Angajatului au fost sterse.");
            pw.close();
        }
        catch (Exception e) {
        }
