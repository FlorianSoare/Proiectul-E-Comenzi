 ...
 * @author soare
 */
public class PlatiManagement extends javax.swing.JFrame{
    private TotalInt it ;
    ...
    /**
     * Un nou formular PlatiManagement
     */
    public PlatiManagement() {
        initComponents();
    ...
    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtonActionPerformed
        ...
        ComandaManagement om = new ComandaManagement();
        om.setVisible(true);
        this.dispose();
    ...
    private void paymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paymentActionPerformed
        ...
        try {
            ...
            PrintWriter pw2 = new PrintWriter(new FileOutputStream("comanda.txt"));
            PrintWriter pw3 = new PrintWriter(new FileOutputStream("totalComanda.txt",true));
    ...
    private void printBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printBActionPerformed
        ...
        try {
            ...
            if(complete){
                ...
                JOptionPane.showMessageDialog(null, "Documentul a fost Imprimat");
            }
            else{
                JOptionPane.showMessageDialog(null, "Anulează Imprimarea","Imprimanta",JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlatiManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlatiManagement().setVisible(true);
            }
        });
    }
