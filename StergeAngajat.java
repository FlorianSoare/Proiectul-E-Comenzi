 ...
 * @author soare
 */
public class StergeAngajat extends javax.swing.JFrame {
    private DltLabour d;
    ...
    public static void main(String args[]) {
        ...
        */
        try {
            ...
            java.util.logging.Logger.getLogger(StergeAngajat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StergeAngajat().setVisible(true);
            }
        });
    }
