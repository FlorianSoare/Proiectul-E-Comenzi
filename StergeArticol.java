 ...
 * @author soare
 */
public class StergeArticol extends javax.swing.JFrame {
    private DltItem d;
    private String dltName;
    /**
     * Creates new form DeleteItem
     */
    public StergeArticol() {
        initComponents();
    ...
    private void dltButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dltButtonActionPerformed
        ...
        d.setName(dltName);
        d.deleteItem();
         JOptionPane.showMessageDialog(this, "Produsul a fost sters");
    ...
    public static void main(String args[]) {
        ...
        */
        try {
            ...
            java.util.logging.Logger.getLogger(StergeArticol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StergeArticol().setVisible(true);
            }
        });
    }
...
class DltItem {
    ...
    public  void deleteItem(){
        ...
        System.out.println(dlt+" va fi șters");
